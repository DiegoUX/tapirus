	...
	$(function () {
        ...
        $("#elastic_grid").elastic_grid({
            ...
            [
                ...
                {
                    'title'         : ' Rediseño de Identidad para ProductoYungas',
                    'description'   : 'La marca ProductoYungas certifica sustentabilidad y origen en las selvas de montaña del norte argentino. Este trabajo aún se encuentra en proceso, incluye rediseño total de marca, manual de usos para empresas certificadas, identidad visual, sitio web, folletería y objetos promocionales.',
                    'thumbnail'     : ['img/porfolio/productoyungas/min-pdy-1.jpg', 'img/porfolio/productoyungas/min-pdy-2.jpg', 'img/porfolio/productoyungas/min-pdy-4.jpg', 'img/porfolio/productoyungas/min-pdy-3.jpg', 'img/porfolio/productoyungas/min-pdy-5.jpg'],
                    'large'         : ['img/porfolio/productoyungas/pdy-1.jpg', 'img/porfolio/productoyungas/pdy-2.jpg', 'img/porfolio/productoyungas/pdy-4.jpg', 'img/porfolio/productoyungas/pdy-3.jpg', 'img/porfolio/productoyungas/pdy-5.jpg'],
                    'button_list'   : [],
                    'tags'          : ['']
                },
